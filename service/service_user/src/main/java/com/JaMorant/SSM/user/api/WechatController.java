...
import com.JaMorant.SSM.utils.JwtHelper;
    ...
    public String userInfo(@RequestParam("code") String code,
        ...
        try {
            ...
            if(userInfo == null) {
                ...
                userInfo.setNickName(wxMpUser.getNickname());  //微信昵称
                userInfo.setAvatar(wxMpUser.getHeadImgUrl());  //微信头像
                userInfo.setSex(wxMpUser.getSexId());    //性别id
//                userInfo.setProvince(wxMpUser.getProvince());  //所在省份
    ...
    @ApiOperation("测试登录")
    public String userInfoo(@RequestParam("code") String code) {
        try {
            //拿着code请求
            WxMpOAuth2AccessToken wxMpOAuth2AccessToken = wxMpService.oauth2getAccessToken(code);
            //获取openid
