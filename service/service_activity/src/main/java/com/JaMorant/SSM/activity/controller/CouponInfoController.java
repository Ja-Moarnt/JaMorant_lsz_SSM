package com.JaMorant.SSM.activity.controller;
...
public class CouponInfoController {
    ...
    public Result save(@RequestBody CouponInfo couponInfo) {
        boolean isSave = couponInfoService.save(couponInfo);
        if (isSave)
            return Result.ok(couponInfo.getId()).message("发放优惠券成功！！！");
        else
            return Result.fail(null).message("发放优惠券失败！！！");
    }
